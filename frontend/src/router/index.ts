...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/admin/dashboard', name: 'AdminDashboard', component: () => import('../views/admin/AdminDashboardView.vue'), meta: { role: 'admin' } },
  ...
  { path: '/admin/pending-orders', name: 'AdminPendingOrders', component: () => import('../views/admin/AdminPendingOrdersView.vue'), meta: { role: 'admin' } },
...
let lastUserId: string | number | null = sessionStorage.getItem('ordering_bot_last_user_id')
...
router.beforeEach((to, _from, next) => {
  ...
  if (currentUserId !== lastUserId) {
    ...
    sessionStorage.setItem('ordering_bot_last_user_id', String(lastUserId ?? ''))
